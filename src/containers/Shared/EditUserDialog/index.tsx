...
import { EditUserDialog as EditUserDialogComponent } from '@/components/Shared/EditUserDialog'; // Point back to Shared component
...
export const EditUserDialog: React.FC<EditUserDialogContainerProps> = ({
  open,
  onClose,
  userId,
}) => {
