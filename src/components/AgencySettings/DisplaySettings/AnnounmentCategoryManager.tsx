...
const AnnouncementCategoryManager: React.FC<CategoryManagerProps> = ({
  categories,
  loading,
  edited,
  setEdited,
        ...
        {loading ? (
          ...
          <div className="px-4 py-4 text-slate-400">
            <div className="min-w-[320px]">
              <span className="pl-3">No Announcement categories found.</span>
            </div>
          </div>
        ) : (
          categories
...
export default AnnouncementCategoryManager;
